...
async function runSeeder() {
    ...
    try {
        ...
        console.log("Emptying previous centros data (cascading deletes to related tables)...");
        await client.query('TRUNCATE TABLE centros CASCADE');
        ...
        for (let i = 0; i < TOTAL_RECORDS; i++) {
            ...
            const centroRes = await client.query(`
                INSERT INTO centros (nombre_establecimiento, parroquia_id, rif, tipo_establecimiento, estado_centro, created_at, updated_at) 
